...
export const CreateReportSchema = z
  .object({
    ...
    // Relacionamentos
    pessoasEnvolvidas: z
      .array(PessoaEnvolvidaSchema)
      .min(1, 'Pelo menos uma pessoa deve estar envolvida'),
    clubesEnvolvidos: z.array(ClubeEnvolvidoSchema).optional().default([]),
    focosManipulacao: z
      .array(FocoManipulacaoEnum)
      .min(1, 'Pelo menos um foco de manipulação deve ser selecionado'),
